...
**Eco-Intelligence** is an edge-based computer vision system that automatically identifies waste items and guides users to the correct disposal bin in real time. Developed for **ICT740 — Hardware Design for AIoT Course** at **TAIST Sciencec Tokyo Master of Engineering in AIoT Program**, the project demonstrates that meaningful environmental AI applications can be built with affordable, low-power embedded hardware.
